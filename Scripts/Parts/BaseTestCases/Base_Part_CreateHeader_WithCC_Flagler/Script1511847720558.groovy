...
not_run: WebUI.click(findTestObject('Parts/PartsSalesOrder/PartsSaleOrderHeader/PartSalesorder_Save'))

WebUI.click(findTestObject('Parts/PartsSalesOrder/PartsSaleOrderHeader/PartSaleOrder_OtherDetailsTab'))

WebUI.delay(2)

WebUI.click(findTestObject('Parts/PartsSalesOrder/PartsSaleOrderHeader/PartSaleOrder_Unit'))
...
WebUI.click(findTestObject('Parts/PartsSalesOrder/PartsSaleOrderHeader/PSO_Header_GeneralTab'))
